...
save(result, result.data, zw,file="data/simulation/powerplotrawdataCBUM+CDD0.005_20iter_cleaned_deltaUnif_infateNR.Rdata")
...
cols<-gg_color_hue(2)
pdf("results/CBUM+CDD0.005_20iter_deltaUnif_inflateNR.pdf", width = 9, height = 9)
